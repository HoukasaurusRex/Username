...
export default {
  ...
  computed: {
    title() {
      return this.$frontmatter?.heroText || this.$frontmatter?.title || this.$site?.title
    },
    description() {
  ...
  <section>
    <div class="profile-img" :style="profileLoadedStyles">
      <transition name="fade">
        <img ref="profileImg" v-show="profileImgLoaded" @load="onLoadProfileImg" src="../public/jt-face-right.webp" height="100%" width="10%" alt=""/>
      </transition>
